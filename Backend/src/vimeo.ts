...
const clientSecret =
  'egj7V3BgUQkhQ7yBV3Yco8uGIgPrlHIjdgqcop4RSbm2+N2LH8Lgt3RAwZJ8i3Rp7ke3Uw5ieGRLuN53+lgVfuTJkYjaVf9XptMF1LNI40LvSmzNch/GgbNDVqeM91rh'
const accessToken = 'a80d2aad19dafa2e5980b4da79ee5828'

if (!clientId || !clientSecret || !accessToken) {
  console.warn(
    'VIMEO CRITICAL WARNING: Missing VIMEO_CLIENT_ID, VIMEO_CLIENT_SECRET, or VIMEO_ACCESS_TOKEN in environment variables. Vimeo API calls WILL FAIL.',
  )
...
let client: any = null // Use 'any' if actual type from 'vimeo' package is hard to use
if (clientId && clientSecret && accessToken) {
  try {
...
export default client // This will be the initialized Vimeo client instance, or null if config failed
